import { createTaskRef, toggleTaskRef, deleteTaskRef, listUserTasksRef, connectorConfig } from '../../esm/index.esm.js';
...
export function useToggleTask(dcOrOptions, options) {
  const { dc: dcInstance, vars: inputOpts } = validateArgs(connectorConfig, dcOrOptions, options);
  function refFactory(vars) {
...
export function useListUserTasks(dcOrVars, varsOrOptions, options) {
